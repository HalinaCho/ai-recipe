...
import { buildInventoryPatch } from "@/lib/inventory/item-patch";
import { consumeItem, updateInventoryItem } from "@/lib/inventory/queries";
...
export async function PATCH(
  ...
  const patch = buildInventoryPatch(body);
